...
sys.path.append(
    "/home/venkat/IF-DV/Rohit/regAlloc/iith-compilers/ML-Register-Allocation/model/RegAlloc/ggnn_drl/rllib_split_model/src"
)
# import inference
    ...
    def getInfo(self, request, context):
        try:
            ...
            if action[select_task_agent] == 1:
                ...
                reply = RegisterAllocationInference_pb2.Data(
                    message="Color", colorData=action[color_agent].encode("utf-8")
                )
            else:
                reply = RegisterAllocationInference_pb2.Data(message="Exit")
            print("------Bye-----", reply)
